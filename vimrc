...
map <F4> :Tagbar<CR> " 引入，可以补全系统，以及python的第三方包 针对新老版本YCM做了兼容
...
func! SetTitle() 
    ...
    call append(line(".")+1, "\# Author: Ukey") 
    call append(line(".")+2, "\# mail: gsl110809@gmail.com") 
...
""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
:highlight Pmenu ctermfg = yellow
:highlight Pmenu ctermbg = 241
